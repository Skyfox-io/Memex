...
- **Decisions.md is append-only here.** Compression lives in `/memex:consolidate`. If the file is approaching its 100-line cap, surface a one-line nudge in the confirmation; don't compress in-line.
