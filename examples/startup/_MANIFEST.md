# _MANIFEST.md - DashFlow Context Routing
...
| [[glossary]] | Term decoder for DashFlow-specific language | STABLE |
...
### Product
Hub: [[product-index]] → Feature specs, user research, MVP scope, design partners

### Go-to-Market
Hub: [[go-to-market-index]] → Positioning, competitive analysis, launch plan, pricing

### Fundraising
Hub: [[fundraising-index]] → Seed deck, investor list, financial model, meeting notes
...
| Go-to-Market | [[go-to-market-index]] |
